...
static struct reg_value ov5640_init_setting_30fps_VGA[] = {
	...
	{0x3c01, 0xa4/*0xa4*/, 0, 0}, {0x3c04, 0x28, 0, 0}, {0x3c05, 0x98, 0, 0},
	...
	{0x5490, 0x1d, 0, 0}, {0x5580, 0x02/*02*/, 0, 0}, {0x5583, 0x40, 0, 0},
...
static struct reg_value sensor_af_firmware[] =
{
	{0x3000, 0x20, 0, 0},
{0x8000, 0x02, 0, 0},
{0x8001, 0x0b, 0, 0},
...
static int ov5640_mipi_probe(struct i2c_client *adapter,
...
int OV5640_auto_focus(void)
{
	...
	ov5640_write_reg(0x3022, 0x03);/*auto focus*/

	while (1) {
		ov5640_read_reg(0x3029, &temp);
		printk(KERN_INFO "ov5640 reg 0x3029 %x\n", temp);
		if (temp == 0x10)
			return 0;
	}
...
int ov5640_set_auto_focus_para(void)
{
	int RegAddr;
	int val;
	struct reg_value *pModeSetting = NULL;
	...
	printk(KERN_INFO "*************************ov5640_set_auto_focus_para\n");
	pModeSetting = sensor_af_firmware;
	ArySize = ARRAY_SIZE(sensor_af_firmware);
	val = ov5640_download_firmware(pModeSetting, ArySize);

	if (val < 0) {
		printk(KERN_INFO "ov5640_set_auto_focus_para err\n");
		return -1;
	}
			    ...
			    enum ov5640_mode mode, enum ov5640_mode orig_mode)
{
	...
	if (mode == ov5640_mode_INIT) {
		...
		ov5640_set_auto_focus_para();/*auto focus*/
...
static int ioctl_g_ctrl(struct v4l2_int_device *s, struct v4l2_control *vc)
{
	...
	case V4L2_CID_BRIGHTNESS:
		printk(KERN_INFO "mipi brightness %d:", ov5640_data.brightness);
		vc->value = ov5640_data.brightness;
		break;
	case V4L2_CID_HUE:
		printk(KERN_INFO "mipi hue %d:", ov5640_data.hue);
 ...
 */
static int ov5640_mipi_probe(struct i2c_client *client,
			const struct i2c_device_id *id)
{
	...
	if (retval < 0 || chip_id_high != 0x56) {
		pr_err("%s:mipi cannot find camera\n", __func__);
		retval = -ENODEV;
		goto err4;
	}
	...
	printk(KERN_INFO "********************* mipi ov5640_probe OK!\n");
	return retval;
